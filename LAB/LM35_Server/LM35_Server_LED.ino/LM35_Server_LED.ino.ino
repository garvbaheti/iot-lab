...
const char* ssid     = "Galaxy M314A54";//Replace with your Wifi Name
const char* password = "kvkv6984";// Replace with your wifi Password

//change your channel number here
unsigned long channel = 1849550;//Replace with your own ThingSpeak Account Channle ID
